...
def plot_ratio_lru():
    ...
    # ============================================================ LRU (
    user_hit_rate = [7.9985169, 28.89807994, 43.59865127, 60.89817287, 71.93190848, 85.08992313, 91.71033198, 95.7009915]
    ad_hit_rate = [20.08817243, 48.86542156, 65.11071238, 80.77210747, 88.16345351, 94.28767818, 96.21911336, 96.81146079]
    # ============================================================ LRU (
