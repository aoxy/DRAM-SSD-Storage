...
def run(algo="lru"):
    ...
    for i in range(5):
        ...
        if algo == "lru":
            print("[LRU]user")
            lru_hit_rate(userid_visit_list, 1, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 5, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 10, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 20, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 30, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 50, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 70, userid_visit_dup_size)
            lru_hit_rate(userid_visit_list, 100, userid_visit_dup_size)
            print("[LRU]adgroup")
            lru_hit_rate(adgroupid_visit_list, 1, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 5, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 10, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 20, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 30, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 50, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 70, adgroupid_visit_dup_size)
            lru_hit_rate(adgroupid_visit_list, 100, adgroupid_visit_dup_size)
        elif algo == "lfu":
            print("[LFU]user")
            lfu_hit_rate(userid_visit_list, 1, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 5, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 10, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 20, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 30, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 50, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 70, userid_visit_dup_size)
            lfu_hit_rate(userid_visit_list, 100, userid_visit_dup_size)
            print("[LFU]adgroup")
            lfu_hit_rate(adgroupid_visit_list, 1, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 5, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 10, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 20, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 30, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 50, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 70, adgroupid_visit_dup_size)
            lfu_hit_rate(adgroupid_visit_list, 100, adgroupid_visit_dup_size)
        else:
            pass
